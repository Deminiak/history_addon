                ...
                <table width="100%" class="table table-middle table-responsive">
                    ...
                    {foreach from=$orders item="o"}
                            <tr>
                                ...
                                <td data-th="{__("user")}">
                                    {if $o.user_id}<a href="{"profiles.update?user_id=`$o.user_id`"|fn_url}">{/if}{$o.username}{if $o.user_id}</a>{/if}
                                </td>
                            </tr>
                    {/foreach}
                </table>
...
{include file="common/mainbox.tpl" title=$page_title  content=$smarty.capture.mainbox buttons=$smarty.capture.buttons  content_id="manage_history"}
